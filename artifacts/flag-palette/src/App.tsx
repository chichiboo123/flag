...
const HELP_CONTENT = {
  ko: {
    ...
    steps: [
      ...
      "🖱️ 국기 카드를 클릭하면 나라 이름, 수도, 대륙, 색상 정보를 볼 수 있어요.",
  ...
  en: {
    ...
    steps: [
      ...
      "🖱️ Click a flag card to see details like capital, continent, and colors.",
  ...
  ja: {
    ...
    steps: [
      ...
      "🖱️ 国旗カードをクリックすると首都・大陸・色情報が表示されます。",
